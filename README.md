...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/geminiapi
```

A live public deployment of this template is available at [https://geminiapi.templates.workers.dev](https://geminiapi.templates.workers.dev)
